...
<div class="remplissage" style="background-color: cyan;"><h1>Le règlement de la Coupe Breitling 100/24</h1></div>
<div class="remplissage" style="background-color: aliceblue;"><h2>règlement général :</h2></div>
...
<div class="remplissage" style="background-color: aliceblue;"><h2>Classement des équipages :</h2></div>
<div class="remplissage">
    <ul  TYPE="square">
